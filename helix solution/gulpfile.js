...
gulp.task("04-Apply-Xml-Transform", function () {
    var layerPathFilters = ["./src/Foundation/**/*.transform", "./src/Feature/**/*.transform", "./src/Project/**/*.transform", "!./src/**/obj/**/*.transform", "!./src/**/bin/**/*.transform", "!./src/Foundation/**/*.cd.transform", "!./src/Foundation/**/*.cm.transform", "!./src/Feature/**/*.cd.transform", "!./src/Feature/**/*.cm.transform", "!./src/Project/**/*.cd.transform", "!./src/Project/**/*.cm.transform"];
